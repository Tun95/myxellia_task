...
//CHAT BUBBLE FILLED
export function JamMessagesF(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
      ...
      {...props}
    >
      {/* Icon from Jam Icons by Michael Amprimo - https://github.com/cyberalien/jam-backup/blob/main/LICENSE */}
      <path
        fill="currentColor"
